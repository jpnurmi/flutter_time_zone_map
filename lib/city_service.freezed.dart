...
abstract class $CityCopyWith<$Res> {
  ...
  $Res call({String country, String name, double latitude, double longitude});
}
...
class _$_City implements _City {
  ...
  @override
  String toString() {
    return 'City(country: $country, name: $name, latitude: $latitude, longitude: $longitude)';
  }
...
abstract class _City implements City {
  factory _City(
      ...
      required String name,
      required double latitude,
      required double longitude}) = _$_City;
